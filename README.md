...
https://www.npmjs.com/package/@permission-protocol/sdk

## Run the demo (10 minutes)
...
- Receipt Standard: [./docs/receipt-standard.md](./docs/receipt-standard.md)
- Playbooks: [./docs/playbooks/](./docs/playbooks/)
- Receipt Challenge: [./docs/receipt-challenge.md](./docs/receipt-challenge.md)
